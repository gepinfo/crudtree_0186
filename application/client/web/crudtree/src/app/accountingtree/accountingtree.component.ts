...
import { AccountingtreeService } from './accountingtree.service';
import { Router } from '@angular/router';

        import { DeletetreeService } from '../deletetree/deletetree.service';
...
@Component({
  selector: 'app-accountingtree',
  templateUrl: './accountingtree.component.html',
  styleUrls: ['./accountingtree.component.scss'],
})
...
export class AccountingtreeComponent implements OnInit {
    ...
    constructor (
        ...
        private accountingtreeService: AccountingtreeService,
    ...
    GpGetAllTree() {
        this.accountingtreeService.GpGetAllTree().subscribe((data:any) => {
    ...
    GpRoute(queryId:any) {
        this.router.navigate(['./deletetree'], { queryParams: { 'id': queryId } })
    }
        ...
        createNode(node: any, savedData: any) {
            return {
                ...
                delete(node: any) {
                    ...
                    this.deletetreeService.GpDelete(node.origin.object._id).subscribe((data:any)=> {
                        this.ngOnInit();
                    });
                }
