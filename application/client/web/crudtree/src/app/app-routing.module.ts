...
{ path : 'deletetree', loadChildren: () => import('./deletetree/deletetree.module').then(m => m.DeletetreeModule), canActivate: [AuthGuard] } , 
{ path : 'accountingtree', loadChildren: () => import('./accountingtree/accountingtree.module').then(m => m.AccountingtreeModule), canActivate: [AuthGuard] } , 
];
